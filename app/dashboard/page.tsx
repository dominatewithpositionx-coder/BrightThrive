...
import { Gift, ChevronRight, Star, Flame, Plus, Sparkles, Tablet, BookHeart } from 'lucide-react';
                  ...
                  <div key={child.id} className="bg-white border border-gray-100 rounded-2xl shadow-sm p-5 hover:shadow-md transition-shadow">
                    ...
                    {childMissions.length > 0 ? (
                      <>
                        ...
                        <Link href="/child" target="_blank" rel="noopener noreferrer" className="text-xs text-teal-600 hover:text-teal-700 font-medium">
                          Open Kid View →
                        </Link>
                      </>
                    ) : (
