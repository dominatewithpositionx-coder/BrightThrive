...
// ── PositionX Preview — /positioning-preview ─────────────────────────────────
// This page is a preview only. The live homepage at / is NOT modified.
// Remove this notice before promoting to production.

export const metadata = {
  title: 'BrytThrive — Helping Families Grow Stronger (Preview)',
  description: 'BrytThrive helps parents turn daily challenges into positive habits, meaningful conversations, and real family progress.',
  robots: 'noindex',
};
...
export default function PositioningPreviewPage() {
  return (
    <div className="text-navy">

      {/* Preview notice — remove before going live */}
      <div className="bg-amber-50 border-b border-amber-200 py-2 px-4 text-center text-xs text-amber-700 font-medium">
        🔍 Preview only — this page is not live. The current homepage at <code className="font-mono">/</code> is unchanged.
      </div>
      ...
      <nav className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <GradientButton href="/onboarding">Start Free</GradientButton>
        </div>
      </nav>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-teal-600 to-teal-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <SectionLabel>
            <span className="text-teal-200">A new category</span>
          </SectionLabel>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              <div key={col.who} className={`${col.bg} rounded-3xl p-7 border ${col.border} shadow-sm`}>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Future expert advisor placeholder */}
      ...
      <section className="py-24 px-4 bg-gradient-to-b from-navy to-gray-900 text-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <GradientButton href="/onboarding">Start Building Better Family Habits</GradientButton>
      ...
      {/* Footer */}
      <div className="bg-gray-900 py-6 px-4 text-center border-t border-gray-800">
        <p className="text-xs text-gray-600">
          © {new Date().getFullYear()} BrytThrive. All rights reserved. · This is a preview page — not yet live.
        </p>
      </div>
